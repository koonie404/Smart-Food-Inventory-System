...
| 분석 단계 | 이미지 가이드 | 설명 |
| :--- | :---: | :--- |
| **Step 1. Detection** | <a href="https://github.com/user-attachments/assets/c9dc5db6-8a98-4fa8-abb9-b4a322779b12"><img width="300" src="https://github.com/user-attachments/assets/c9dc5db6-8a98-4fa8-abb9-b4a322779b12" alt="다중 접시 탐지"></a> | YOLOv8 모델을 활용하여 실시간 배식 접시 검출. |
| **Step 2. Masking** | <a href="https://github.com/user-attachments/assets/b60ceb98-190a-4dd7-b426-61e2223147fd"><img width="300" src="https://github.com/user-attachments/assets/b60ceb98-190a-4dd7-b426-61e2223147fd" alt="음식 영역 추출"></a> | HSV 색상 분석을 통한 순수 음식 영역 마스킹. |
| **Step 3. Result** | <a href="https://github.com/user-attachments/assets/f3aaa148-06d3-433d-8052-ea3d3307cf8d"><img width="300" src="https://github.com/user-attachments/assets/f3aaa148-06d3-433d-8052-ea3d3307cf8d" alt="최종 모니터링 화면"></a> | 5프레임 필터 적용 후 실시간 상태 표시 (Enough/Prepare/REFILL). |
